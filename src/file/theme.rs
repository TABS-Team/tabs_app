...
fn create_default_themes() -> Themes {
    ...
    themes.insert("default".to_string(),
        Theme {
            primary: Color::srgb(1.0, 0.7216, 0.0),           // #ffb800
            secondary: Color::srgb(0.0627, 0.0667, 0.0627),   // #101110
            third: Color::srgb(0.9725, 0.9608, 0.9804),       // #F8F5FA
            text_primary: Color::srgb(0.8196, 0.8118, 0.8118),// #d1cfcf
            text_secondary: Color::srgb(0.8196, 0.8118, 0.8118),// #d1cfcf
            text_third: Color::srgb(0.9725, 0.9608, 0.9804),  // #F8F5FA
            background_default: Color::srgb(0.1490, 0.1529, 0.1451), // #262725
            ...
            action_active: Color::srgb(1.0, 0.7216, 0.0),     // #ffb800
        },
    );
